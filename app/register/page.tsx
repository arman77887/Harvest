...
import { Sprout, Loader2, Lock, Mail, User } from "lucide-react";
    ...
    <div className="min-h-[75vh] flex items-center justify-center px-4 py-12">
      <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-md w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-500">Join Harvest Hub for fresh farm produce</p>
        </div>
        ...
        <div className="text-center border-t border-gray-100 pt-4 text-xs text-gray-500">
          ...
          <Link href="/login" className="text-harvest-600 font-semibold hover:underline">
            Sign In
          </Link>
        </div>
      </div>
